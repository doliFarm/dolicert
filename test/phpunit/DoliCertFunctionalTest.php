...
/**
 * \file    test/phpunit/DoliCertFunctionalTest.php
 * \ingroup dolicert
 ...
 *
 * @package Testdolicert
 */
class DoliCertFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/dolicert/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('dolicert/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/dolicert/admin/about.php');
		$this->authenticate();
		return $this->assertContains('dolicert/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('dolicertwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDoliCert_DoliCertTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDoliCert_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
